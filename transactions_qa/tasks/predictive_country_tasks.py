...
@dataclass
class PredCountryTaskOpenEnded(CategoricalTaskAbstract):

    def __post_init__(self):
        self.task_name = "pred_country_open-ended"
        self.target_feature_name = 'country'  # 24 unique values

        self.task_special_token = None
        self.task_specific_special_token = "[pred_country_openended]"

        self.num_classes = 25  # from 1 to 24 inclusive
