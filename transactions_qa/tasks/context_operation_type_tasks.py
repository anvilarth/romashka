...
@dataclass
class MostFrequentOpTypeTaskOpenEnded(CategoricalTaskAbstract):

    def __post_init__(self):
        self.task_name = "most_frequent_operation_type_open-ended"
        self.target_feature_name = 'operation_type'  # 22 unique values

        self.task_special_token = None
        self.task_specific_special_token = "[most_freq_operation_type_openended]"

        self.num_classes = 23  # from 1 to 22, inclusive
...
@dataclass
class LastOpTypeTaskOpenEnded(CategoricalTaskAbstract):

    def __post_init__(self):
        self.task_name = "last_operation_type_open-ended"
        self.target_feature_name = 'operation_type'  # 22 unique values

        self.task_special_token = None
        self.task_specific_special_token = "[last_operation_type_openended]"
...
@dataclass
class MostFrequentOpTypeGroupTaskOpenEnded(CategoricalTaskAbstract):

    def __post_init__(self):
        self.task_name = "most_frequent_operation_type_group_open-ended"
        self.target_feature_name = 'operation_type_group'  # 4 unique values

        self.task_special_token = None
        self.task_specific_special_token = "[most_freq_operation_type_group_openended]"

        self.num_classes = 5  # from 1 to 4, inclusive
        self.is_text_task = False
        self.is_binary_task = False
        self.is_open_ended_task = True
        self.metrics = torch.nn.ModuleDict({
...
@dataclass
class LastOpTypeGroupTaskOpenEnded(CategoricalTaskAbstract):

    def __post_init__(self):
        self.task_name = "last_operation_type_group_open-ended"
        self.target_feature_name = 'operation_type_group'  # 4 unique values

        self.task_special_token = None
        self.task_specific_special_token = "[last_operation_type_group_openended]"
