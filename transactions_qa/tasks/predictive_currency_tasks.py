...
@dataclass
class PredCurrencyTaskOpenEnded(CategoricalTaskAbstract):

    def __post_init__(self):
        self.task_name = "pred_currency_open-ended"
        self.target_feature_name = 'currency'  # 11 unique values

        self.task_special_token = None
        self.task_specific_special_token = "[pred_currency_openended]"

        self.num_classes = 12  # from 1 to 11 inclusive
        ...
        self.ending_prompts = [
            ". What is the currency of the next transaction?"
            " Answer an index of a currency starting from 1 to 11 inclusive.",
            ". What is the currency of the next transaction based on the provided transaction history?"
            " Answer an index of a currency starting from 1 to 11 inclusive.",
            ". Choose in which currency the upcoming transaction will be made."
            " Answer an index of a currency starting from 1 to 11 inclusive.",
            ". Select the currency of the next transaction."
            " Answer an index of a currency starting from 1 to 11 inclusive.",
            ". Find out what is the currency of upcoming transaction."
            " Answer an index of a currency starting from 1 to 11 inclusive.",
            ". Can you please answer the question: what is the currency of the next transaction?"
            " Answer an index of a currency starting from 1 to 11 inclusive.",
            ". Determine the currency of the next transaction."
            " Answer an index of a currency starting from 1 to 11 inclusive.",
            ". Select the currency of the upcoming transaction based on provided history."
            " Answer an index of a currency starting from 1 to 11 inclusive.",
            ". Choose the currency of the next transaction."
            " Answer an index of a currency starting from 1 to 11 inclusive.",
            ". Can you find out in which currency will be the next transaction?"
            " Answer an index of a currency starting from 1 to 11 inclusive.",
            ". Answer the question: what is the currency of the upcoming transaction?"
            " Answer an index of a currency starting from 1 to 11 inclusive.",
        ]
