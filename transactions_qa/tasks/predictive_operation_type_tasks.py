...
@dataclass
class PredOpTypeTaskOpenEnded(CategoricalTaskAbstract):

    def __post_init__(self):
        self.task_name = "pred_operation_type_open-ended"
        self.target_feature_name = 'operation_type'  # 22 unique values

        self.task_special_token = None
        self.task_specific_special_token = "[pred_operation_type_openended]"
...
@dataclass
class PredOpTypeGroupTaskOpenEnded(CategoricalTaskAbstract):

    def __post_init__(self):
        self.task_name = "pred_operation_type_group_open-ended"
        self.target_feature_name = 'operation_type_group'  # 4 unique values

        self.task_special_token = None
        self.task_specific_special_token = "[pred_operation_type_group_openended]"
