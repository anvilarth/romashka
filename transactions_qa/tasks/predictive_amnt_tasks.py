...
@dataclass
class PredRealNumericAmountTaskOpenEnded(NumericTaskAbstract):
    """
    A task for predictive exact Open-ended QA task: given a discrete or continuous numeric target - Amount,
    answer question with exact numeric answer.
    """
    ...
    def __post_init__(self):
        self.task_name = "pred_real_numeric_amount_open-ended"
        self.target_feature_name = 'amnt_realval'  # [0, 1] range of values
